        ...
        <div className="mt-10">
            ...
            <div style={{backgroundColor: "#FFEAD0"}} className="p-6">
                ...
                <div className="flex justify-between mb-5">
                    ...
                    <Link className="hover:underline hover:text-gray-900" to="/host/income">Details</Link>
                </div>
            ...
            <div style={{backgroundColor: "#FFDDB2"}} className="review-score flex justify-between p-6 pt-9 pb-9">
                ...
                <Link className="hover:underline hover:text-gray-900" to="/host/reviews/">Details</Link>
            </div>

            {/* Listed Vans */}
                <div className='flex justify-end'>

                    <Link className="mt-10 me-6 hover:underline hover:text-gray-900" to="/host/vans/">View All</Link>
                </div>
                    <HostVans />
